...
if($query->num_rows > 0)
{
  if($rating_out_of_5 != 1 && $rating_out_of_5 != 2 && $rating_out_of_5 != 3 && $rating_out_of_5 != 4 && $rating_out_of_5 != 5) {
	...
	{
		//worked fine
		echo "<script type='text/javascript'>alert('You have successfully rated these lecture notes!')
      	window.location = 'student_lecture_notes.php';</script>";
	}
	else{
		//user already submitted 
		echo "<script type='text/javascript'>alert('You have already rated these lecture notes!')
      	window.location = 'student_lecture_notes.php';</script>";
	}
  }
}
